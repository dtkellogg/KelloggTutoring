...
import { listAppointments, deleteAppointment, createAppointment, updateAppointment } from '../actions/appointmentActions'
import { APPOINTMENT_CREATE_RESET } from '../constants/appointmentConstants'
import AdminAppointmentCreate from '../components/AdminAppointmentCreate'
...
export default function AdminAppointmentsList({ location, history, match }) {
    ...
    const { loading: loadingCreate, error: errorCreate, success: successCreate, product: createdProduct } = appointmentCreate;
